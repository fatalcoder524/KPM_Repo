# HMA++
HMA++ is a KPM used to hide paths like /storage/emulated/0/Android/data/ and acts as an addon to HMA developed by @lshwjgpt

Follow him and support him on GitHub here: https://github.com/lshwjgpt25
...
## HMA++_0.0.3.kpm
- [HMA++] to the beginning of the log for easy viewing

## HMA++_0.0.2.kpm
- Added chdir hook
- fstatat hook
- rmdir/unlinkat hook
- ⚠️⚠️⚠️This module is not tested at all please do not embed!⚠️⚠️⚠️
- ⚠️This module only assists HMA, not replaces HMA⚠️
